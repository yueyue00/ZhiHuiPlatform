...
public class HomeHotelLocationsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = LayoutInflater.from(mContext).inflate(
				R.layout.fragment_hotel_locations_home, null);
	...
	private void initView(View view) {
		...
		SupportMapFragment map1 = (SupportMapFragment) (((FragmentActivity) mContext)
				...
				.findFragmentById(R.id.baidu_map_hotel));
		...
		hotel_lv = (ListView) view.findViewById(R.id.home_hotel_lv);
...
//		}
		...
		strbuf.append("method=getHotelList&userid=wangsy");
		strbuf.append("&lg=1");
	...
	private void process(int position) {
		for (int i = 0; i < hotels.size(); i++) {
			...
			if (hotelInfo.lat != null && hotelInfo.lat != null)
				hotelInfo.ll = new LatLng(Double.parseDouble(hotelInfo.lat),
