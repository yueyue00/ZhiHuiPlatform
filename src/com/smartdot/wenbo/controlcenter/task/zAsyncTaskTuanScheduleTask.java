...
public class zAsyncTaskTuanScheduleTask extends
	...
	public zAsyncTaskTuanScheduleTask(Message m, Context context,
	...
	protected Integer doInBackground(Integer... params) {
		try {
			...
			URL url = new URL(Constant.DOMAIN
					+ "/deptAction.do?method=getLuntanByDept&userId=" + userid
					+ "&deptid=" + deptid);
			...
			if (is != null) {
				...
				System.out
						.println("=======调用了zAsyncTaskTuanScheduleTask的doInBackground方法-->"
								+ json);
				// 当info的数据为空的时候
