...
public class MSharePreferenceUtils {
	/** 保存在手机里面的文件名 */
	private static final String FILE_NAME = "share_contact";

	private static SharedPreferences sp;
	private static SharedPreferences.Editor editor;
	private static MSharePreferenceUtils preferenceUtil;

	private MSharePreferenceUtils(Context context, String spFileName) {
		sp = context.getSharedPreferences(spFileName, Context.MODE_PRIVATE);
		editor = sp.edit();
	}

	private MSharePreferenceUtils(Context context) {
		sp = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
		editor = sp.edit();
	}

	public static MSharePreferenceUtils getAppConfig(Context context,
			String spFileName) {
		if (preferenceUtil == null) {
			preferenceUtil = new MSharePreferenceUtils(context, spFileName);
		}
		return preferenceUtil;
	}

	public static MSharePreferenceUtils getAppConfig(Application context) {
		if (preferenceUtil == null) {
			preferenceUtil = new MSharePreferenceUtils(context);
		}
		return preferenceUtil;
	}
